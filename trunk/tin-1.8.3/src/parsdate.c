...
static const yytype_uint8 yyprhs[] =
{
      ...
      24,    29,    36,    43,    45,    47,    50,    53,    55,    57,
      61,    67,    70,    75,    78,    82,    88,    91,    94,    97,
     100,   101
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      20,    -1,    22,    -1,    23,    -1,    10,    24,    -1,    10,
      13,    10,    24,    -1,    10,    13,    10,    21,    -1,    10,
      13,    10,    13,    10,    24,    -1,    10,    13,    10,    13,
      10,    21,    -1,    11,    -1,     4,    -1,     4,    12,    -1,
      11,    21,    -1,    21,    -1,     9,    -1,    10,    14,    10,
      -1,    10,    14,    10,    14,    10,    -1,     6,    10,    -1,
       6,    10,    15,    10,    -1,    10,     6,    -1,    10,     6,
      10,    -1,     3,    15,    10,     6,    10,    -1,     9,     8,
      -1,    10,     8,    -1,     9,     7,    -1,    10,     7,    -1,
      -1,     5,    -1
};
...
{
       0,   134,   134,   135,   138,   147,   151,   154,   159,   171,
     177,   184,   190,   200,   204,   208,   212,   220,   226,   247,
     251,   263,   267,   272,   276,   281,   288,   291,   294,   297,
     302,   305
};
#endif
...
static const char *const yytname[] =
{
  ...
  "tDST", "':'", "'/'", "','", "$accept", "spec", "item", "time", "zone",
...
{
       2,     0,     1,     0,     0,     0,    30,     3,     4,     6,
       7,     0,    21,    28,    26,    31,    23,    29,    27,     0,
       0,     8,    14,    18,    13,     5,    17,     0,     0,    24,
      30,    19,    15,    16,     0,    22,     0,    10,     9,     0,
      25,    30,    20,    12,    11
};
...
{
     -30,     4,   -30,    -7,     1,    -5,    13,   -30,    25,   -30,
     -30,     5,     7,   -30,   -30,   -30,     6,   -30,   -30,    15,
      20,   -30,    11,   -30,    22,   -30,   -30,    27,    28,   -30,
      19,    21,   -30,   -30,    29,   -30,    30,   -30,   -30,    31,
     -30,     0,   -30,   -30,   -30
};
...
{
      33,    38,    13,    14,     2,    15,    37,     3,    11,    23,
       4,    12,    44,     5,     6,    27,    29,    43,    15,    16,
      17,    18,    28,    32,    15,    30,    19,    20,    23,    22,
      31,    23,    36,    34,    23,    39,    24,     0,    35,    40,
      41,    42
};

static const yytype_int8 yycheck[] =
{
      24,    30,     7,     8,     0,     5,    30,     3,    15,     9,
       6,    10,    41,     9,    10,    10,    10,    41,     5,     6,
       7,     8,    15,    12,     5,    10,    13,    14,     9,     4,
      10,     9,    13,     6,     9,    14,    11,    -1,    10,    10,
      10,    10
};
...
{
       0,    17,     0,     3,     6,     9,    10,    18,    19,    22,
      23,    15,    10,     7,     8,     5,     6,     7,     8,    13,
      14,    24,     4,     9,    11,    20,    21,    10,    15,    10,
      10,    10,    12,    21,     6,    10,    13,    21,    24,    14,
      10,    10,    10,    21,    24
};
...
#line 226 "./parsdate.y"
    {
	    ...
	    if ((int)(yyvsp[(1) - (1)].Number) < 0) {
		/* Don't work with negative modulus. */
		(yyvsp[(1) - (1)].Number) = -(int)(yyvsp[(1) - (1)].Number);
